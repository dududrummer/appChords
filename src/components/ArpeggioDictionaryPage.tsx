...
import { ArpeggioDictionary } from './ArpeggioDictionary';
...
export function ArpeggioDictionaryPage({
  instrument, stringNames, stringCount, markerColor, primaryColor, onInstrumentChange, openedCreation
}: Props) {
    ...
    <Card className="w-full">
      <CardHeader>
        <div className="flex items-center gap-2">
          ...
          <CardTitle>Dicionário de Arpejos</CardTitle>
        </div>
      </CardHeader>
