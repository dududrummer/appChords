    ...
    <div className="min-h-screen bg-neo-bg flex flex-col items-center justify-center px-4 py-12 relative">
      ...
      <div className="relative z-10 w-full max-w-lg">
        ...
        <NeubrutalistCard className="p-8">
          ...
          {success && <div className="bg-green-50 border-2 border-green-600 px-4 py-2 mb-4 font-bold text-sm text-green-700">{success}</div>}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex gap-3 mt-6">
                ...
                <NeubrutalistButton size="lg" className="flex-1" type="submit" disabled={isLoading}>
                  {authAction === "email" ? <><Loader2 className="h-5 w-5 animate-spin mr-2" />Criando...</> : "Criar Conta"}
                </NeubrutalistButton>
              </div>
            </form>
          )}
